...
title: |
  ![](logo.png){width=3in}  
  Note GMDS SUMMER ACADEMY 2024 - Estimands
author: "Zehui Bai"
...
Potential clinical questions of interest
• What is the effect of test treatment with rescue medication as
needed vs placebo with rescue medication as needed on HbA1c
change from baseline to Week 26? (TP)

• What is the effect of test treatment vs placebo on...
• ... HbA1c change from baseline to Week 26 as if rescue medication had not
been made available? (H)
• x% in HbA1c from baseline to Week 26 and no need to take rescue at any
time? (C)
• HbA1c change from baseline to Week 26 or time of rescue medication usage
whichever occurs earlier? (P)
• change from baseline to Week 26 in those patients who would not need
rescue medication regardless of their treatment assignment? (W)
...
knitr::include_graphics("./02_Plots/Estimand_S0_1.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S0_2.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S0_4.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S0_5.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Missing_QA.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_ScQA.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_ThinkProcess.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S1_Case1.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S1_Case1Es.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S1_Case2Es.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S2_Case.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S2_TPShema.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S2_TPMissing.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S2_MI_JR.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S2_MI_CIR.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S2_MI_CR.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S2_MI_MAR.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S2_MI_RDO.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S2_MIScheme.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S2_Results.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S2_Case.png") 
knitr::include_graphics("./02_Plots/Estimand_S3_HYSheme.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S3_Causal.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S3_Causal2.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S3_Causal3.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S3_IPW.png") 
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Estimand_S3_Results.png") 
```
