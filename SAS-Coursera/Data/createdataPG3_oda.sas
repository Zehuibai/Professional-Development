...
%let path=/home/&sysuserid/EPG3M6;
...
%let url=%str(http://dl.liveweb.sas.com/eldata/epg3m6_oda.zip);
...
%let setup=%superq(unzip)/data/pg3m6.sas;    
...
%unpack(%superq(path),epg3m6.zip,epg3m6)

/* added to set &path for elearning */
 %let path=/home/&sysuserid/EPG3M6/data; 
